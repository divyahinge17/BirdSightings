                ...
                <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#" className="flex justify-center items-center">
                            <div>
                                {imageSrc ? (
                                    <img src={imageSrc} alt={`Image of ${birdName}`} style={{ width: '300px', height: '250px', marginTop: '25px', borderRadius: '0.5rem' }} />
                                ) : (
                    ...
                    <div style={{ width: '600px', height: '533px', border: '1px solid black', marginLeft: '100px', boxShadow: '0 8px 8px rgba(0, 0, 0, 0.5)' }}>
