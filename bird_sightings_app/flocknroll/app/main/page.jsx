    ...
    return (
        <div>
            ...
            <div className="flex justify-center items-center h-screen">
                <div className="cardmargin max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 mb-8">
                    <a href="#">
                        <Image
